...
export default function Sidebar() {
    return (
        <div backgroundColor="#191c25!important" style={{ display: 'flex', position: 'fixed', height: '100vh', overflow: 'scroll initial' }}>
            <CDBSidebar textColor="#fff" backgroundColor="#191c25!important">
